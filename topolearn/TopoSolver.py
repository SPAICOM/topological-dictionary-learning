...
if __name__ == "__main__":
    ...
    from .Hodgelets import *
    from .EnhancedGraph import EnhancedGraph
else:
    from topolearn.data_generation import *
    from topolearn.utilsTopoSolver import *
    from topolearn.Hodgelets import *
    from topolearn.EnhancedGraph import EnhancedGraph
...
class TopoSolver:
    ...
    def JTDL(
        ...
        """
        assert (
            self.dictionary_type == "separated"
